...
x_radius = get_val_from_input_array(param_input, "x_radius")
...
pos_log = open("/home/fvg/contiki-ng/examples/6tisch/msf/topo_graph_density", "r+")
input_lines = pos_log.readlines()
pos_log.close()
pos_log_key = 'pos-net' + str(node_num) + '-lqr' + str(rx_success) + '-it' + str(itr) + '-radius' + str(x_radius) + '='
seed_log_key = 'seed-net' + str(node_num) + '-lqr' + str(rx_success) + '-it' + str(itr) + '-radius' + str(x_radius) + '='
random_seed = 123456
...
file_w = open("/home/fvg/contiki-ng/examples/6tisch/msf/topo-density-config/config.csc", "w+")
...
newPath = shutil.copy('/home/fvg/contiki-ng/examples/6tisch/msf/topo-density-config/config.csc', '/home/fvg/contiki-ng/examples/6tisch/msf')
