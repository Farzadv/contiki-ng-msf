...
make msf-node.cooja TARGET=cooja</commands>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype396</identifier>
      <description>Cooja Mote Type #3</description>
      <source>[CONTIKI_DIR]/examples/6tisch/msf/msf-node-2udp.c</source>
      <commands>make clean TARGET=cooja
make TARGET=cooja viewconf
make msf-node-2udp.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      ...
      <motetype_identifier>mtype396</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.434529290504777 0.0 0.0 4.434529290504777 195.05230591974734 326.1443230626071</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
